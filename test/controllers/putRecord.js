...
test('[put] missing collection -> missing db -> proxy to a none existing collection', async t => {
  t.plan(2);
...
test('[put] missing collection -> existing db -> proxy to a none existing collection', async t => {
  t.plan(2);
...
test('[put] missing collection -> proxy to an existing collection', async t => {
  t.plan(3);
